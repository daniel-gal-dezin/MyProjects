...
public class Mage extends Player{
    ...
    public String describe() {
        return String.format("%s\t\tProject.Health: %s\t\tAttack: %d\t\tDefense: %d \t\tProject.Level: %d \t\tExperience: %d \t\tCurrent Mana: %d \t\tSpell Power: %d ", getName(), getHealth().getCurrentHealth(), getAttack(), getDefense(), getLevel(), getExperience(), getCurrentMana(), getSpellPower());
    }
