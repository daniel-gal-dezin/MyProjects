...
public class Rogue extends Player {
    ...
    public String describe() {
        return String.format("%s\t\tProject.Health: %s\t\tAttack: %d\t\tDefense: %d \t\tProject.Level: %d \t\tExperience: %d \t\tEnergy: %d", getName(), getHealth().getCurrentHealth(), getAttack(), getDefense(), getLevel(), getExperience(), getCurrentEnergy());
    }
