...
import Project.MassageCallback;
...
public class Warrior extends Player {
    ...
    public String describe() {
        return String.format("%s\t\tProject.Health: %s\t\tAttack: %d\t\tDefense: %d \t\tProject.Level: %d \t\tExperience: %d \t\tCD: %d", getName(), getHealth().getCurrentHealth(), getAttack(), getDefense(), getLevel(), getExperience(), getRemainingCoolDown());
    }
